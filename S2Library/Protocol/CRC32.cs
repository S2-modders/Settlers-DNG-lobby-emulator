...
namespace S2Library.Protocol
{
    public class Crc32
    {
        public static uint Calculate(byte[] data, uint previousCrc32 = 0)
        {
            return Calculate(data, 0, data.Length, previousCrc32);
        }

        public static uint Calculate(byte[] data, int offset, int count, uint previousCrc32 = 0)
        {
            if (data == null)
            {
            ...
            return LittleEndian(data, offset, count, previousCrc32);
        }

        private static uint LittleEndian(byte[] data, int offset, int count, uint previousCrc32)
        {
